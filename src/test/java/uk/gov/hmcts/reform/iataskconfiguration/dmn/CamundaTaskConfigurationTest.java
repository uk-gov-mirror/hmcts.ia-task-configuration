...
class CamundaTaskConfigurationTest extends DmnDecisionTableBaseUnitTest {
    ...
    void listTheCase_stf24w_overrides_isIntegrated_for_description_link() {
        ...
        inputVariables.putValue(
            "caseData", Map.of(
                "stf24wCurrentStatusAutoGenerated", "Yes",
    ...
    void reviewSkeleton_stf24w_overrides(boolean isStf24w) {
        String roleAssignmentId = UUID.randomUUID().toString();
        String taskId = UUID.randomUUID().toString();
        VariableMap inputVariables = new VariableMapImpl();
        inputVariables.putValue(
        ...
        inputVariables.putValue(
            "caseData", Map.of(
                "stf24wPreviousStatusWasYesAutoGenerated", isStf24w ? "Yes" : "No"
            )
        );
        ...
        assertEquals(1, descriptionList.size());
        assertEquals(
            isStf24w ? "[Request hearing requirements](/case/IA/Asylum/${[CASE_REFERENCE]}/trigger/requestHearingRequirementsFeature)<br />[Request case edit](/case/IA/Asylum/${[CASE_REFERENCE]}/trigger/requestCaseEdit)"
                : "[Request respondent review](/case/IA/Asylum/${[CASE_REFERENCE]}/trigger/requestRespondentReview)<br />[Request case edit](/case/IA/Asylum/${[CASE_REFERENCE]}/trigger/requestCaseEdit)",
            descriptionList.getFirst().get("value")
        );
    }
