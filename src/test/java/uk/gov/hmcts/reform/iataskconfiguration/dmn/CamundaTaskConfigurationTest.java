...
class CamundaTaskConfigurationTest extends DmnDecisionTableBaseUnitTest {
    ...
    @ParameterizedTest
    @ValueSource(booleans = {true, false})
    void reviewReasonsForAppeal_stf24w_overrides(boolean isStf24w) {
        String roleAssignmentId = UUID.randomUUID().toString();
        String taskId = UUID.randomUUID().toString();
        VariableMap inputVariables = new VariableMapImpl();
        inputVariables.putValue(
    ...
    @ParameterizedTest
    @ValueSource(booleans = {true, false})
    void reviewHoResponse_stf24w_overrides(boolean isStf24w) {
        String roleAssignmentId = UUID.randomUUID().toString();
        String taskId = UUID.randomUUID().toString();
        VariableMap inputVariables = new VariableMapImpl();
        inputVariables.putValue(
        ...
        assertEquals(isStf24w, desc.contains("[Send Direction to Respondent to make changes to non-compliant Review](/case/IA/Asylum/${[CASE_REFERENCE]}/trigger/sendDirection)"));
    }
